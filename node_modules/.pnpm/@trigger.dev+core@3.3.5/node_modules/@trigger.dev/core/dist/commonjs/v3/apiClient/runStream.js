    ...
    const $options = {
        provider: {
            async onShape(callback) {
                return (0, stream_js_1.zodShapeStream)(api_js_1.SubscribeRunRawShape, url, callback, options);
            },
        },
        streamFactory: new SSEStreamSubscriptionFactory((0, getEnv_js_1.getEnvVar)("TRIGGER_STREAM_URL", (0, getEnv_js_1.getEnvVar)("TRIGGER_API_URL")) ?? "https://api.trigger.dev", {
...
class RunSubscription {
    ...
    constructor(options) {
        ...
        this.stream = (0, stream_js_1.createAsyncIterableStream)(source, {
    ...
    withStreams() {
        ...
        return (0, stream_js_1.createAsyncIterableStream)(this.stream, {
