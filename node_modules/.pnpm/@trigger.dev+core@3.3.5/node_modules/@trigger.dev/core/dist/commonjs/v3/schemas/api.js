...
exports.UpdateMetadataRequestBody = zod_1.z.object({
...
exports.SubscribeRunRawShape = zod_1.z.object({
    ...
    createdAt: zod_1.z.coerce.date(),
    updatedAt: zod_1.z.coerce.date(),
    startedAt: zod_1.z.coerce.date().nullish(),
    delayUntil: zod_1.z.coerce.date().nullish(),
    queuedAt: zod_1.z.coerce.date().nullish(),
    expiredAt: zod_1.z.coerce.date().nullish(),
    completedAt: zod_1.z.coerce.date().nullish(),
    taskIdentifier: zod_1.z.string(),
