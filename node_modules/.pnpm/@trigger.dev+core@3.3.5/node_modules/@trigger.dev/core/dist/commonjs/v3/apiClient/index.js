...
class ApiClient {
    ...
    batchTriggerV2(body, clientOptions, requestOptions) {
        return (0, core_js_1.zodfetch)(index_js_1.BatchTriggerTaskV2Response, `${this.baseUrl}/api/v1/tasks/batch`, {
            method: "POST",
            headers: this.#getHeaders(clientOptions?.spanParentAsLink ?? false, {
    ...
    subscribeToRun(runId, options) {
        return (0, runStream_js_1.runShapeStream)(`${this.baseUrl}/realtime/v1/runs/${runId}`, {
    ...
    subscribeToBatch(batchId, options) {
        return (0, runStream_js_1.runShapeStream)(`${this.baseUrl}/realtime/v1/batches/${batchId}`, {
            closeOnComplete: false,
            headers: this.#getRealtimeHeaders(),
            client: this,
            signal: options?.signal,
    ...
    retrieveBatch(batchId, requestOptions) {
        return (0, core_js_1.zodfetch)(index_js_1.RetrieveBatchResponse, `${this.baseUrl}/api/v1/batches/${batchId}`, {
            method: "GET",
            headers: this.#getHeaders(false),
        }, mergeRequestOptions(this.defaultRequestOptions, requestOptions));
    }
